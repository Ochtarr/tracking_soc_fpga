...
set C_modelArgList {
	{ AXI_video_strm_V_data_V int 24 regular {pointer 0 volatile }  }
	{ AXI_video_strm_V_keep_V int 3 regular {pointer 0 volatile }  }
	{ AXI_video_strm_V_strb_V int 3 regular {pointer 0 volatile }  }
	{ AXI_video_strm_V_user_V int 1 regular {pointer 0 volatile }  }
	{ AXI_video_strm_V_last_V int 1 regular {pointer 0 volatile }  }
	{ AXI_video_strm_V_id_V int 1 regular {pointer 0 volatile }  }
	{ AXI_video_strm_V_dest_V int 1 regular {pointer 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "AXI_video_strm_V_data_V", "interface" : "wire", "bitwidth" : 24, "direction" : "READONLY"} , 
 	{ "Name" : "AXI_video_strm_V_keep_V", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
 	{ "Name" : "AXI_video_strm_V_strb_V", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
 	{ "Name" : "AXI_video_strm_V_user_V", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	{ "Name" : "AXI_video_strm_V_last_V", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	{ "Name" : "AXI_video_strm_V_id_V", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	{ "Name" : "AXI_video_strm_V_dest_V", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ AXI_video_strm_V_data_V sc_in sc_lv 24 signal 0 } 
	{ AXI_video_strm_V_keep_V sc_in sc_lv 3 signal 1 } 
	{ AXI_video_strm_V_strb_V sc_in sc_lv 3 signal 2 } 
	{ AXI_video_strm_V_user_V sc_in sc_lv 1 signal 3 } 
	{ AXI_video_strm_V_last_V sc_in sc_lv 1 signal 4 } 
	{ AXI_video_strm_V_id_V sc_in sc_lv 1 signal 5 } 
	{ AXI_video_strm_V_dest_V sc_in sc_lv 1 signal 6 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "AXI_video_strm_V_data_V", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "AXI_video_strm_V_data_V", "role": "default" }} , 
 	{ "name": "AXI_video_strm_V_keep_V", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "AXI_video_strm_V_keep_V", "role": "default" }} , 
 	{ "name": "AXI_video_strm_V_strb_V", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "AXI_video_strm_V_strb_V", "role": "default" }} , 
 	{ "name": "AXI_video_strm_V_user_V", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "AXI_video_strm_V_user_V", "role": "default" }} , 
 	{ "name": "AXI_video_strm_V_last_V", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "AXI_video_strm_V_last_V", "role": "default" }} , 
 	{ "name": "AXI_video_strm_V_id_V", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "AXI_video_strm_V_id_V", "role": "default" }} , 
 	{ "name": "AXI_video_strm_V_dest_V", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "AXI_video_strm_V_dest_V", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "3", "Max" : "791555"}
	, {"Name" : "Interval", "Min" : "3", "Max" : "791555"}
]}
...
set Spec2ImplPortList { 
	AXI_video_strm_V_data_V { ap_none {  { AXI_video_strm_V_data_V in_data 0 24 } } }
	AXI_video_strm_V_keep_V { ap_none {  { AXI_video_strm_V_keep_V in_data 0 3 } } }
	AXI_video_strm_V_strb_V { ap_none {  { AXI_video_strm_V_strb_V in_data 0 3 } } }
	AXI_video_strm_V_user_V { ap_none {  { AXI_video_strm_V_user_V in_data 0 1 } } }
	AXI_video_strm_V_last_V { ap_none {  { AXI_video_strm_V_last_V in_data 0 1 } } }
	AXI_video_strm_V_id_V { ap_none {  { AXI_video_strm_V_id_V in_data 0 1 } } }
	AXI_video_strm_V_dest_V { ap_none {  { AXI_video_strm_V_dest_V in_data 0 1 } } }
