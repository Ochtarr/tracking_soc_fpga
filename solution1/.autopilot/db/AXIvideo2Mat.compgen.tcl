...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { AXI_video_strm_V_data_V { I 24 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { AXI_video_strm_V_keep_V { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { AXI_video_strm_V_strb_V { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { AXI_video_strm_V_user_V { I 1 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { AXI_video_strm_V_last_V { I 1 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { AXI_video_strm_V_id_V { I 1 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { AXI_video_strm_V_dest_V { I 1 vector } } \
} "
}
