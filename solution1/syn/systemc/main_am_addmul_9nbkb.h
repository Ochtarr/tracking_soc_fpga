...
#ifndef __main_am_addmul_9nbkb__HH__
#define __main_am_addmul_9nbkb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(main_am_addmul_9nbkb) {
    ...
    SC_CTOR(main_am_addmul_9nbkb):  simcore_am_0_U ("simcore_am_0_U") {
